...
export const CONVERTERS_ROUTES: Routes = [
    ...
    { path: 'texto', loadChildren: () => import('../text-converter/text-converter.routes').then(m => m.TEXT_CONVERTER_HOME_ROUTES) },
    { path: 'texto-para-binario', loadChildren: () => import('../text-converter/text-converter.routes').then(m => m.TEXT_CONVERTER_BINARY_ROUTES) },
    { path: 'texto-para-morse', loadChildren: () => import('../text-converter/text-converter.routes').then(m => m.TEXT_CONVERTER_MORSE_ROUTES) },
