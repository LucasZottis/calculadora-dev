...
export const DECIMAL_TIME_ROUTES: Routes = [
    { path: '', redirectTo: 'converter-horas-minutos-segundos-para-numero-decimal', pathMatch: 'full' },
    { path: 'converter-horas-minutos-segundos-para-numero-decimal', component: DecimalTimeConverterPageComponent },
];